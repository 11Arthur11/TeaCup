...
console.log(`API coverage OK: ${operationIds.length - intentionallyServerSide.size}/${operationIds.length} client-facing operations referenced; callback/test/panel-owned endpoints intentionally excluded.`);
