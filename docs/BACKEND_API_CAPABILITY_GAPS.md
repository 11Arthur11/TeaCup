...
پاسخ باید سبک و تجمیعی باشد:

- موجودی کیف پول
- تعداد کل/فعال/در حال استقرار/نیازمند تمدید سرویس‌ها
- تعداد فاکتورهای در انتظار
- تعداد تیکت‌های باز
- نزدیک‌ترین تاریخ انقضا
- آخرین فعالیت‌های مهم

**شکاف فعلی:** موجودی از endpoint واقعی دریافت می‌شود، اما سایر متریک‌ها mock هستند. بدون endpoint تجمیعی، ساخت داشبورد واقعی نیازمند چند درخواست هم‌زمان است.
